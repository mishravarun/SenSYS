package com.snu.msl.sensys.SyncAdapter.Provider;
...
public class Provider extends ContentProvider {
    public static final String PROVIDER_NAME = "com.snu.msl.sensys.provider";
    ...
    public static final String sensordronePressure = "sensordronepressure";
    public static final String sensordroneIRTemperature = "sensordroneirtemperature";
    public static final String sensordroneIlluminance = "sensordroneilluminance";
    public static final String sensordronePrecisionGas = "sensordroneprecisiongas";
    public static final String sensordroneCapacitance = "sensordronecapacitance";
    public static final String sensordroneExternalVoltage = "sensordroneexternalvoltage";
    ...
    static final String CREATE_DB_TABLE = " CREATE TABLE " + TABLE_NAME
            ...
            + " sensordronepressure TEXT NOT NULL, "
            ...
            + " sensordroneexternalvoltage TEXT NOT NULL, "
            + " sensordronebatteryvoltage TEXT NOT NULL);";
